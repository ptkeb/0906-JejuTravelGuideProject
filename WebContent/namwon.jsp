...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
	...
	실제로 가보니 나무가 우거진 모습이 정말 한반도 지형과 똑 닮았다. 주차장에 차를 세우고 산책로를 따라 조금 걸어 들어가면 볼 수 있는데,<br>
	걷다가 뒤를 돌아야만 비로소 보이기 때문에 놓치지 않도록 주의해야 한다. (유독 이쪽에만 사람들이 많이 모여 있어서 사실 그냥 지나치긴 힘들다.)
	해 질 무렵 이곳을 찾으면 마치 남과 북이 나뉜 것처럼 절반은 붉게 물든 하늘, 절반은 푸른 바다가 보이는 모습도 이색적이다.<br>
	2km의 산책길을 따라 펼쳐진 비경이 매우 훌륭하니, 여기만 보고 돌아가지 말고 꼭 끝까지 걸어보길 바란다.
	</p>
	<br><hr><br>
	...
	제주 동백 마을은 주로 '토종 동백'이 피어나는 지역이라 개화 시기가 조금 늦는 편. 11월이면 활짝 피는 위미리의 '애기 동백'과는 달리 대략 12월 말부터 볼 수 있으며, 분홍빛이 아닌 붉은빛을 띠고,<br>
	꽃이 질 때 꽃잎이 낱장이 아닌 봉오리째 떨어지는 게 특징이다. 동백 고목 외에도 팽나무, 생달나무 등 다양한 나무들이 함께 어우러져 있는 동백 숲도 둘러보고, 한적한 마을 길을 걸으며 나만의 동백 스폿을 발견해보자.  
	</p>
	<br><hr><br>
	...
	그럴 땐 감귤 농장이나 귤 밭이 있는 카페, 혹은 테마파크 등에서 아쉬움을 달래보자.
	‘휴애리 자연생활농원’에서는 매년 10월부터 2월까지 감귤 체험을 할 수 있는 데, 입장료와 별도로 5,000원의 요금을 내면 귤밭에서 마음껏 귤도 따먹고, 달고 맛있는 귤을 골라 준비된 봉지에 담아 갈 수 있다.<br>
	인디언 텐트, 테이블, 의자, 가랜드, 하트 모양 조형물 등 다양한 포토존이 조성되어 있어 인생 사진을 남길 수도 있다.<br>
	휴애리 내에는 두 개의 감귤장이 있는데, 시기와 당도에 따라 다르게 개방된다고 하니 참고할 것. 사진이 목적이라면 파란 하늘이 보이는 화창한 날씨에 방문하는 것을 추천한다.<br>
